        ...
        <div className="flex min-h-[60vh] flex-col items-center justify-center p-8 bg-matter-dark font-sans animate-in fade-in duration-500">
            ...
            {showCancelConfirm && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                    <div className="bg-matter-surface border border-red-900/50 w-full max-w-md rounded-lg shadow-2xl overflow-hidden relative flex flex-col">
                        <div className="p-6 text-center">
                            <div className="mx-auto w-16 h-16 bg-red-900/20 border border-red-500/50 rounded-full flex items-center justify-center mb-4">
                                <XCircle className="w-8 h-8 text-red-500" />
                            </div>
                            <h3 className="text-xl font-bold text-white font-mono uppercase mb-2">Cancel Delivery?</h3>
                            ...
                            <div className="flex gap-4">
                                <button 
                                    ...
                                    className="flex-1 bg-transparent border border-matter-border text-white py-3 rounded text-sm font-bold uppercase tracking-wider hover:bg-slate-800 transition-colors"
                                >
                                    Keep Order
                                </button>
                                <button 
                  ...
                  <div className="p-6 space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                          <button 
                            ...
                            className="flex items-center justify-center gap-2 border border-matter-border bg-matter-surface hover:bg-white/5 hover:border-white/20 py-3 transition-all group rounded-sm"
                          >
                              <svg className="w-4 h-4 text-slate-400 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.008 5.96H5.078z"/></svg>
